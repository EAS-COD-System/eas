// server.js
// EAS Tracker backend (Node 18+ / Render)
// -------------------------------------------------
...
app.delete('/api/products/:id', requireAuth, (req, res) => {
  ...
  // deliveries are country-only (no product), so we leave them
...
app.post('/api/snapshots/restore', requireAuth, async (req, res) => {
  ...
  // IMPORTANT: do NOT delete snapshot after push
