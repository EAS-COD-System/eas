// server.js
// EAS Tracker backend (Node 18/20, works on Render)
...
app.post('/api/products', requireAuth, (req, res) => {
  ...
  const p = {
    ...
    budgets: req.body.budgets || {} // manual per-country budget (product page)
  };
